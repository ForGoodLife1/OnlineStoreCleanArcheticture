namespace OnlineStore.Data.AppMetaData
{
    public static class Router
    {
        ...
        public static class OrderRouting
        {
            ...
            public const string GetDepartmentCustomersCount = Prefix + "/ Order-Customers-Count";
            public const string GetDepartmentCustomersCountById = Prefix + "/ Order-Customers-Count-ById/{id}";
